        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{PHP_START}echo site_url('admin'); {PHP_END}"><i class="fa fa-dashboard"></i> Home</a></li>
...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{PHP_START}echo lang('{MODULE_TITLE}'); {PHP_END}</h3>
