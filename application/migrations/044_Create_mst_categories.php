...
/**
* Migration_Create_mst_categories
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_categories extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_categories'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_categories', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_categories');
    }
}