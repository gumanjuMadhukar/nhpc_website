...
/**
* Migration_Create_mst_subject_committee
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_subject_committee extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_subject_committee'))
        {
            // Setup Keys 
            ...
            $this->dbforge->add_field(array(
                ...
                'subject_committee_type_id'                 => array('type' => 'int',       'constraint' => 11),
            ));

            $this->dbforge->create_table('mst_subject_committee', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_subject_committee');
    }
}