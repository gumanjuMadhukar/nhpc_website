...
/**
* Migration_Create_mst_subject_committee_type
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_subject_committee_type extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_subject_committee_type'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_subject_committee_type', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_subject_committee_type');
    }
}