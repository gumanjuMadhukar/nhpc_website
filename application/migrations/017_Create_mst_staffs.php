...
/**
* Migration_Create_mst_staffs
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_staffs extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_staffs'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_staffs', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_staffs');
    }
}