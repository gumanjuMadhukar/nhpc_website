...
/**
* Migration_Create_mst_syllabus
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_syllabus extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_syllabus'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_syllabus', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_syllabus');
    }
}