...
/**
* Migration_Create_mst_popup
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_popup extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_popup'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_popup', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_popup');
    }
}