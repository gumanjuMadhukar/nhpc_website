...
/**
* Migration_Create_mst_province
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_province extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_province'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_province', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_province');
    }
}