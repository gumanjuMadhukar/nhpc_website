...
/**
* Migration_Create_mst_services
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_services extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_services'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_services', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_services');
    }
}