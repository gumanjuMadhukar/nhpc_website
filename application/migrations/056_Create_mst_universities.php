...
/**
* Migration_Create_mst_universities
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_universities extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_universities'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_universities', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_universities');
    }
}