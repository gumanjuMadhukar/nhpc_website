...
/**
* Migration_Create_mst_photos
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_photos extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_photos'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_photos', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_photos');
    }
}