...
class Nepali_Calendar {
	...
	/**
	 * Get Nepali Month String for given month in numeric value
	 * 
	 * @access private
	 * @param integer $m
	 * @return string
	...
	{
		$nepali_months = array("N/A", "Baishak", "Jestha", "Ashad", "Shrawn", "Bhadra", "Ashwin", "kartik", "Mangshir", "Poush", "Magh", "Falgun", "Chaitra");
		return (isset($nepali_months[$m])) ? $nepali_months[$m] : false;
	}

	/**
	 * Get English Month String for given month in numeric value
	 * 
	 * @access private
	 * @param integer $m
	 * @return string
	...
	{
		$english_months = array("N/A", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December");

		return (isset($english_months[$m])) ? $english_months[$m] : false;
	}

	/**
	 * Get Day String for given day in numeric value
	 * 
	 * @access private
	 * @param integer $day
	 * @return string
	...
	/**
	 * Check the given english date in Range or not
	 * 
	 * @access private
	 * @param integer $yy
	 * @param integer $mm
	...
	/**
	 * Check the given nepali date in Range or not
	 * 
	 * @access private
	 * @param integer $yy
	 * @param integer $mm
	...
	* @return mixed
	*/
	public function AD_to_BS($yy, $mm, $dd, $format = 'string')
	{
		...
		if ($format == 'string')
			return $total_nDays . '&nbsp;' . $this->nep_date["nmonth"] . '&nbsp;' . $y;
		else
	...
	*/
	...
	{
		$index = substr((string) $year, 2);
		$days = $this->bs[$index][(int)$month];
...
/* End of file Nepali_Calendar.php */
/* Location: ./application/libraries/Nepali_Calendar.php */
