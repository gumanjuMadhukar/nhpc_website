...
/**
* Migration_Create_mst_programmes
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_programmes extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_programmes'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_programmes', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_programmes');
    }
}