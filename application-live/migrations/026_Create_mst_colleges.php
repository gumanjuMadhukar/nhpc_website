...
/**
* Migration_Create_mst_colleges
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_colleges extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_colleges'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_colleges', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_colleges');
    }
}