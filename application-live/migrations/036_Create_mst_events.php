...
/**
* Migration_Create_mst_events
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_events extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_events'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_events', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_events');
    }
}