...
/**
* Migration_Create_mst_publications
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_publications extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_publications'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_publications', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_publications');
    }
}