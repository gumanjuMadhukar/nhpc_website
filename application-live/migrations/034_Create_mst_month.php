...
/**
* Migration_Create_month
*
* Extends the CI_Migration class
* 
*/
class Migration_Create_mst_month extends CI_Migration {

    function up() 
    {       

        if ( ! $this->db->table_exists('mst_month'))
        {
            // Setup Keys 
            ...
            $this->dbforge->create_table('mst_month', TRUE);
        }
    }

    function down() 
    {
        $this->dbforge->drop_table('mst_month');
    }
}