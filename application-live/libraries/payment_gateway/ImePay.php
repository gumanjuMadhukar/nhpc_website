...
class ImePay {
    ...
    public function initilize($payment_info,$merchant_detial)
    {
    	$data['AMT'] = $db_data['amt'] = 1;//$this->CI->input->post('amount');
    	$data['MD'] = $db_data['md'] = 'p';
    	$data['CRN'] = $db_data['currency'] = 'NRP';
    	$data['DT'] = $db_data['date'] = date('m/d/Y');
    	$data['R1'] = $db_data['r1'] = 'test';//$this->CI->input->post('number');
    	$data['R2'] = $db_data['r2'] = 'test';//'Phone Recharge';
    	...
    	$data['RU'] = site_url('transactions/fonepay_return_url');
    	$data['PID'] = 'YXSB';
    	// $data['PID'] = 'XRORSU';
