...
class AdminPermissions extends Project_Controller
{
	...
	public function json()
	{
		...
		$rows=$this->permission_model->find_all();
    ...
    public function get_permission_groups()
    {
        ...
        $results = $this->group_permission_model->find_all();
        ...
        $results = $this->group_model->find_all();
    ...
    public function get_permission_users()
    {
        ...
        $results = $this->user_permission_model->find_all();
