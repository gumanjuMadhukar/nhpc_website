...
<tr>
	<td><input type="text" name="column[<?php echo $i?>]" class="form-control"></td>
	<td><select name="type[<?php echo $i?>]" class="form-control">
	...
	<td><input type="number" name="length[<?php echo $i?>]" class="form-control"></td>
	<td><input type="checkbox" name="primary_key[<?php echo $i?>]"></td>
	<td><input type="checkbox" name="have_default[<?php echo $i?>]"></td>
	<td><input type="text" name="default[<?php echo $i?>]" class="form-control"></td>
</tr>
