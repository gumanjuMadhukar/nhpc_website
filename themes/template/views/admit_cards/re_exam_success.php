					...
					<div class="tab-content" id="pills-tabContent">
						<div class="tab-pane fade show active" id="pills-HP" role="tabpanel" aria-labelledby="pills-home-tab">
							<div class="tab-card"> 
                                ...
                                <?php if($result == 1){ ?>
                                        <h3>You have successfully uploaded the voucher. Our administration team will confirm it and get back to you very soon. Thank you!</h3>
                                    <?php }else{?>
                                        <h3>There is a problem while uploading the voucher Please try again</h3>
