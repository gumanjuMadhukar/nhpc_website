           ...
           <div class="table-responsive">
	          	<table style="width: 100% !important" class="table table-hover dataTable table-striped" id="Boardmember-table">
	                <thead>
						...
						<th ><?php echo lang('selected_from')?></th>
						<th>Action</th>
	                </thead>
	              	<tbody></tbody>
	          	</table>
  	...
  	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class='form-group'>
				<label for='selected_from'><?php echo lang('selected_from')?></label>
				<input id='selected_from' type='text' class='form-control' name='selected_from'>
				</div>
				<div class='form-group'>
	...
	$(function(){
		dataTable = $('#Boardmember-table').DataTable({
			...
			'ajax' : { url: "<?php  echo site_url('admin/Boardmembers/json'); ?>",type: 'POST' },
				...
				{ data: "selected_from",name: "selected_from"},
